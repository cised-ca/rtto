...
class WhatPageComponent extends React.Component {
  render() {
    ...
    return (
      <div className="page placeholderpage-component container">
        ...
        <h1>What is a social enterprise?</h1>
...
WhatPageComponent.displayName = 'WhatPageComponent';

export { WhatPageComponent };
export default translate('placeholder')(WhatPageComponent);
