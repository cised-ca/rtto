...
class NearbyPageComponent extends React.Component {
  render() {
    ...
    return (
      <div className="page placeholderpage-component container">
        ...
        <h1>Find nearby social enterprises</h1>
...
NearbyPageComponent.displayName = 'NearbyPageComponent';

export { NearbyPageComponent };
export default translate('placeholder')(NearbyPageComponent);
